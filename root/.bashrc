...
if [ -f $HOME/.scripts/git-prompt.sh ]; then
  ...
  #export PS1="\[\033[40m\]\[\033[31m\][ \u@\H:\[\033[36m\]\w\$(__git_ps1 \" \[\033[35m\]{\[\033[32m\]%s\[\033[35m\]}\")\[\033[34m\] ]$\[\033[0m\] "
  export PS1="\[\033[40m\]\[\033[31m\]\u@\H:\w\$(__git_ps1 \" \[\033[35m\]{\[\033[32m\]%s\[\033[35m\]}\")$\[\033[0m\] "
else
  export PS1="\[\033[40m\]\[\033[31m\]\u@\H:\w\$\[\033[0m\] "
fi
